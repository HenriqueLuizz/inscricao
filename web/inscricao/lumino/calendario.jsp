<%-- 
    Document   : calendario
    Created on : 21/06/2016, 10:47:34
    Author     : usuario
--%>
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		-->
                <ul class="nav menu">
			<li class="active"><a href="index.html"><svg class="glyph stroked dashboard-dial"><use xlink:href="#stroked-dashboard-dial"></use></svg> Painel Inicial</a></li>
			<li><a href="cadastro.html"><svg class="glyph stroked pencil"><use xlink:href="#stroked-pencil"></use></svg> Cadastrar</a></li>
			<li><a href="calendatio.html"><svg class="glyph stroked calendar"><use xlink:href="#stroked-calendar"></use></svg> Calendario</a></li>
			<li><a href="geral.html"><svg class="glyph stroked table"><use xlink:href="#stroked-table"></use></svg> Classificados</a></li>
